...
From <https://github.com/0voice/cpp_new_features/>
...
```cpp
85         // 十进制
0213       // 八进制 0x4b       // 十六进制 30         // 整数 30u        // 无符号整数 30l        // 长整数 30ul       // 无符号长整数
```
...
#include <iostream>
using namespace std;
#define LENGTH 10   //constexpr int 
#define WIDTH  5    //constexpr int
#define NEWLINE '\n' //constexpr char
int main(){
   int area;  
...
int main(){
   ...
   c = a - b;   cout << "Line 2 - c 的值是 " << c << endl ;
   c = a * b;   cout << "Line 3 - c 的值是 " << c << endl ;
...
```cpp
$./a.outWriting to the file
Enter your name: Zara
Enter your age: 9
Reading from the fileZara9
```
...
| 函数对象（functors） | 重载了operator()函数的对象，通常有一元和二元函数对象。       |
